...
export default function PreviewPage() {
  return (
    <PageWrapper className="tablet:gap-x-8 tablet:px-4 desktop:px-6 tablet:pb-8 desktop:grid-cols-12 desktop:auto-rows-min mx-auto grid auto-rows-auto grid-cols-1 pt-4">
      {/* Video Section */}
      <section className="desktop:col-end-13 desktop:row-span-5 desktop:col-start-1 relative col-start-1 row-span-2 row-start-1 grid grid-cols-subgrid grid-rows-subgrid">
        <Suspense
          fallback={
